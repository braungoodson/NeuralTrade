    ...
    <script type="text/ng-template" id="R6b">
      <div class="container" style="margin-top:50px">
        <div class="starter-template">
            ...
            <br/><br/>
            <span ng-controller="R6bController">
              <button type="button" class="btn btn-lg btn-success">$ {{bot.cash}}</button><br/>
              <button type="button" class="btn btn-lg btn-warning">BTC {{bot.btc}}</button><br/>
              <button type="button" class="btn btn-lg btn-primary">Profit {{bot.profit}}</button><br/>
              <button type="button" class="btn btn-lg btn-info">Rate {{bot.rate}}</button><br/>
              <button type="button" class="btn btn-lg btn-danger">Prediction {{bot.prediction}}</button><br/>
            </span>
        </div>
      </div><!-- /.container -->
    </script>
