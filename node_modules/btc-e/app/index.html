  ...
  <body>
    ...
    <script type="text/javascript" id="web-app-boostrap">
      ...
      bootModule.controller('R6bController',['$scope','$http',function($scope,$http){
        ...
        var datasets = [{
          data: [500,501,493,515,525]
        },{
          data: [495,500,490,505,510,515,500]
        }];
        ...
        $scope.chart = new Chart($("#myChart").get(0).getContext("2d")).Line($scope.chartData,{animation:false});
